...
- PostgreSQL: set `DATABASE_URL` to your provider URL, e.g. `postgresql://host:5432/dbname`
- MySQL: set `DATABASE_URL` to your provider URL, e.g. `mysql://host:3306/dbname`
