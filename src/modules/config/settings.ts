...
export function getSettingGroups(): SettingGroup[] {
  return [
    ...
    },
    {
      name: 'usage_billing',
      title: 'Usage Billing',
      description: 'Credits charged for model usage and runtime sessions',
      tab: 'general',
    },
...
export function getSettings(): Setting[] {
  return [
    ...
    },
    {
      ...
      title: 'Description',
      type: 'text',
      placeholder: 'Trial credits',
      group: 'credit',
      tab: 'general',
      defaultValue: 'Trial credits',
    },
    {
    ...
    {
      name: 'billing_model_gate_enabled',
      title: 'Enable model request balance gate',
      type: 'switch',
      group: 'usage_billing',
      tab: 'general',
      defaultValue: 'false',
    ...
    {
      name: 'billing_runtime_meter_enabled',
      title: 'Enable incremental runtime billing',
      type: 'switch',
      group: 'usage_billing',
      tab: 'general',
      defaultValue: 'false',
    ...
    {
      name: 'billing_session_free_minutes',
      title: 'Free minutes per session',
      type: 'number',
      placeholder: '5',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'billing_runtime_idle_credits_per_minute',
      title: 'Idle runtime credits / minute',
      type: 'number',
      placeholder: '1',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'billing_runtime_active_credits_per_minute',
      title: 'Active runtime credits / minute',
      type: 'number',
      placeholder: '2',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'billing_runtime_high_load_credits_per_minute',
      title: 'High-load runtime credits / minute',
      type: 'number',
      placeholder: '5',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'billing_runtime_meter_interval_minutes',
      title: 'Runtime billing interval minutes',
      type: 'number',
      placeholder: '1',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'billing_runtime_meter_max_catchup_minutes',
      title: 'Maximum runtime catch-up minutes',
      type: 'number',
      placeholder: '2',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'billing_session_min_balance_credits',
      title: 'Minimum credits to start session',
      type: 'number',
      placeholder: '0',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'billing_idle_timeout_minutes',
    ...
    {
      name: 'billing_max_session_minutes',
    ...
    {
      name: 'billing_storage_credits_per_gb_day',
      title: 'Storage credits / GB / day',
      type: 'number',
      placeholder: '1',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'billing_daily_free_network_gb',
      title: 'Daily free network GB',
      type: 'number',
      placeholder: '1',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'billing_network_credits_per_gb',
      title: 'Network credits / GB',
      type: 'number',
      placeholder: '10',
      group: 'usage_billing',
      tab: 'general',
    ...
    },
    {
      ...
      title: 'Usage webhook secret',
      type: 'password',
      placeholder: 'Internal secret for runtime usage callbacks',
      group: 'usage_billing',
      tab: 'general',
    },
